...
This Code of Conduct applies within all project spaces, and it also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers at conduct@greengate.local. All complaints will be reviewed and investigated promptly and fairly.
...
1. **Correction** – Private, written warning with clarity around future behavior.
2. **Warning** – Written warning with consequences for continued behavior.
3. **Temporary Ban** – Temporary suspension of participation in any community spaces.
4. **Permanent Ban** – Permanent revocation of any kind of participation.
